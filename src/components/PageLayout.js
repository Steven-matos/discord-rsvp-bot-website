...
/**
 * Page layout component providing consistent header, footer, and navigation for standalone pages
            ...
            <div className="hidden lg:flex items-center space-x-1">
              {navigationLinks.map((link) => (
                <a
                  key={link.id}
                  href={link.href}
                  className="px-4 py-2 rounded-lg text-gray-300 hover:text-white hover:bg-gray-700/50 transition duration-300 ease-in-out font-medium"
                >
                  {link.label}
                </a>
              ))}
            ...
            <div className="flex flex-col space-y-2">
              {navigationLinks.map((link) => (
                <a
                  key={link.id}
                  href={link.href}
                  className="block px-3 py-2 rounded-lg text-gray-300 hover:text-white hover:bg-gray-700/50 transition duration-300 ease-in-out font-medium"
